# Generated by Django 4.0 on 2022-02-19 14:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Краткое описание книги', max_length=1000, verbose_name='Аннотация книги')),
                ('isbn', models.CharField(help_text='Должен содержать 13 символов', max_length=13, verbose_name='ISBN книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imprint', models.CharField(help_text='Введите издание и год выпуска', max_length=200, verbose_name='Издательство')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ForeignKey(help_text='Введите жанр для книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.genre', verbose_name='Жанр книги'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
